    ...
    if request.method == "POST":
        ...
        if user is not None:
            if user.is_active:
	            ...
	            return render(request, 'Calculator/questionnaire.html')
...
def user_register(request):
    ...
    if form.is_valid():
        ...
        message = 'Please click to register'
...
def user_questionnaire(request):
	...
	if request.method == "POST":
		...
		variables.boolean_colledge_loan = request.POST.get("boolean_colledge_loan", False)
	...
	context = {
		...
		"financial_knowledge" : variables.financial_knowledge,
		"boolean_bank_account" : variables.boolean_bank_account,
		"boolean_car" : variables.boolean_car,
		"boolean_home" : variables.boolean_home,
		"boolean_children" : variables.boolean_children,
		"boolean_credit_cards" : variables.boolean_credit_cards,
		"boolean_colledge_loan" : variables.boolean_colledge_loan,
		"boolean_medical_debt" : variables.boolean_medical_debt,
		}
